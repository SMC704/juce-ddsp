...
private:
    ...
    juce::Image backgroundTexture = juce::ImageFileFormat::loadFrom(BinaryData::background_texture_dark_headline_png, BinaryData::background_texture_dark_headline_pngSize);
