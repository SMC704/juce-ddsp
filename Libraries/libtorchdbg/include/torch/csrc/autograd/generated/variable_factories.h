...
inline at::Tensor arange(at::Scalar end, at::TensorOptions options = {}) {
  at::AutoNonVariableTypeMode non_var_type_mode(true);
...
inline at::Tensor arange(at::Scalar start, at::Scalar end, at::TensorOptions options = {}) {
  at::AutoNonVariableTypeMode non_var_type_mode(true);
...
inline at::Tensor arange(at::Scalar start, at::Scalar end, at::Scalar step, at::TensorOptions options = {}) {
  at::AutoNonVariableTypeMode non_var_type_mode(true);
...
inline at::Tensor empty_meta(at::IntArrayRef size, at::TensorOptions options = {}, c10::optional<at::MemoryFormat> memory_format = c10::nullopt) {
  at::AutoNonVariableTypeMode non_var_type_mode(true);
  return autograd::make_variable(at::empty_meta(size, at::TensorOptions(options).requires_grad(c10::nullopt), memory_format), /*requires_grad=*/options.requires_grad());
}
...
inline at::Tensor full(at::IntArrayRef size, at::Scalar fill_value, c10::optional<at::DimnameList> names, at::TensorOptions options = {}) {
  at::AutoNonVariableTypeMode non_var_type_mode(true);
...
inline at::Tensor full(at::IntArrayRef size, at::Scalar fill_value, at::TensorOptions options = {}) {
  at::AutoNonVariableTypeMode non_var_type_mode(true);
...
inline at::Tensor full_like(const at::Tensor & self, at::Scalar fill_value, at::TensorOptions options = {}, c10::optional<at::MemoryFormat> memory_format = c10::nullopt) {
  at::AutoNonVariableTypeMode non_var_type_mode(true);
...
inline at::Tensor linspace(at::Scalar start, at::Scalar end, c10::optional<int64_t> steps = c10::nullopt, at::TensorOptions options = {}) {
  at::AutoNonVariableTypeMode non_var_type_mode(true);
...
inline at::Tensor logspace(at::Scalar start, at::Scalar end, c10::optional<int64_t> steps = c10::nullopt, double base = 10.0, at::TensorOptions options = {}) {
  at::AutoNonVariableTypeMode non_var_type_mode(true);
...
inline at::Tensor scalar_tensor(at::Scalar s, at::TensorOptions options = {}) {
  at::AutoNonVariableTypeMode non_var_type_mode(true);
...
inline at::Tensor randperm(int64_t n, at::TensorOptions options = {}) {
  at::AutoNonVariableTypeMode non_var_type_mode(true);
...
inline at::Tensor randperm(int64_t n, c10::optional<at::Generator> generator, at::TensorOptions options = {}) {
  at::AutoNonVariableTypeMode non_var_type_mode(true);
...
inline at::Tensor range(at::Scalar start, at::Scalar end, at::Scalar step = 1, at::TensorOptions options = {}) {
  at::AutoNonVariableTypeMode non_var_type_mode(true);
...
inline at::Tensor range(at::Scalar start, at::Scalar end, at::TensorOptions options = {}) {
  at::AutoNonVariableTypeMode non_var_type_mode(true);
